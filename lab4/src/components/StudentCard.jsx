  ...
  return (
    <div className="group bg-white border border-slate-200 rounded-2xl p-5 hover:border-indigo-300 hover:shadow-md hover:-translate-y-1 transition-all duration-300">
      ...
      <button
        ...
        className="w-full py-2.5 bg-white border border-rose-200 text-rose-600 text-sm font-medium rounded-xl hover:bg-rose-50 hover:border-rose-300 transition-all duration-200 flex items-center justify-center gap-2"
      >
