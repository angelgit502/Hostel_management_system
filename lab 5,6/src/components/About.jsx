    ...
    <section id="about" className="bg-slate-50 py-24 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-slate-500 text-center max-w-2xl mx-auto mb-16 text-lg leading-relaxed">
          HomeAwayy automates and streamlines all hostel administrative operations — from student enrollment
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <p className="text-slate-800 font-bold text-sm">HomeAwayy Dashboard</p>
